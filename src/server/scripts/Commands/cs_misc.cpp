...
public:
    ...
    {
        Player* target = NULL;
        std::string announce = " |cffff0000[Server]:|r";
        ...
        if (sWorld->getBoolConfig(CONFIG_SHOW_KICK_IN_WORLD))
        {
           announce = "|cffFF8C00 The character |r |cffD63931";
           announce += playerName.c_str();
           announce += " |r |cffFF8C00was kicked by the character |r |cffD63931";
           announce += handler->GetSession()->GetPlayerName();
           announce += "|r |cffFF8C00.|r \n";
    ...
    **/
    ...
    {
        std::string announce = " |cffff0000[Admin]:|r";
        ...
        if (sWorld->getBoolConfig(CONFIG_SHOW_MUTE_IN_WORLD))
        {
            ...
            announce += "|r |cffFF8C00 was muted for ";
            announce += delayStr;
            announce += " minutes by the character |r |cffD63931";
            announce += handler->GetSession()->GetPlayerName();
            announce += "|r |cffFF8C00. The reason is: ";
