/*
 * Copyright (C) 2012 BattleCore <https://github.com/Vitasic/Battle>
 * Copyright (C) 2012 Vitasic <https://github.com/Vitasic>
 * Copyright (C) 2012 Vitasic <http://vk.com/vit_pokataev>
 */
...
class LearnSpellsOnLevelUp : public PlayerScript
{
        ...
        {
			bool EnableAutoLearnSpell = ConfigMgr::GetBoolDefault("Enable.Learn.Spell.On.Level.Up", true);
			if (EnableAutoLearnSpell)
			{
